    ...
    <section ref={containerRef} className="w-full bg-white py-24 lg:py-32 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-heading font-bold text-3xl lg:text-[40px] text-[var(--color-ffg-navy)] mb-16 lg:mb-20 text-center">
          Two Engines That Scale Trust Into Capital
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div ref={rightCardRef} className="bg-[var(--color-ffg-bg)] rounded-3xl p-10 lg:p-14 flex flex-col relative overflow-hidden group border border-[var(--color-ffg-border)]">
            {/* Visual Abstract bg */}
