      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="group relative bg-white/95 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-sm hover:shadow-xl transition-all duration-300 ease-out flex flex-col items-start border-t-4 border-[var(--color-ffg-navy)] hover:-translate-y-1">
            ...
            <div className="overflow-hidden max-h-0 group-hover:max-h-[400px] transition-[max-height] duration-500 delay-300 group-hover:delay-0 ease-[cubic-bezier(0.4,0,0.2,1)] w-full">
              <div className="pt-8 flex flex-col h-[280px] border-t border-[var(--color-ffg-border)] mt-6">
                ...
                <div className="mt-auto flex items-center gap-2 bg-[var(--color-ffg-forest)]/10 text-[var(--color-ffg-forest)] px-3 py-2 rounded-lg w-fit group-hover:animate-[pulse-verified_0.5s_ease-out]">
          ...
          <div className="group relative bg-white/95 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 ease-out flex flex-col items-start border-t-4 border-[var(--color-ffg-navy)] hover:-translate-y-1">
            ...
            <div className="overflow-hidden max-h-0 group-hover:max-h-[400px] transition-[max-height] duration-500 delay-300 group-hover:delay-0 ease-[cubic-bezier(0.4,0,0.2,1)] w-full">
              <div className="pt-8 flex flex-col h-[280px] border-t border-[var(--color-ffg-border)] mt-6">
                ...
                <div className="mt-auto p-4 glass rounded-xl relative overflow-hidden bg-[var(--color-ffg-bg)]">
          ...
          <div className="group relative bg-white/95 backdrop-blur-sm rounded-2xl p-8 lg:p-10 shadow-sm hover:shadow-xl transition-all duration-300 ease-out flex flex-col items-start border-t-4 border-[var(--color-ffg-navy)] hover:-translate-y-1">
            ...
            <div className="overflow-hidden max-h-0 group-hover:max-h-[400px] transition-[max-height] duration-500 delay-300 group-hover:delay-0 ease-[cubic-bezier(0.4,0,0.2,1)] w-full">
              <div className="pt-8 flex flex-col h-[280px] border-t border-[var(--color-ffg-border)] mt-6">
                ...
                <div className="mt-auto relative h-16 w-full flex items-center justify-center">
